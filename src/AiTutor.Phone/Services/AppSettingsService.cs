...
public interface IAppSettingsService
{
    ...
    void SaveCurrentSubject(string subject);
...
public class AppSettingsService : IAppSettingsService
{
    ...
    private const string CurrentSubjectKey = "aitutor_current_subject";
    ...
    {
        return Preferences.Get(CurrentSubjectKey, "数学");
    }
    ...
    public void SaveCurrentSubject(string subject)
    {
        ...
        Preferences.Set(CurrentSubjectKey, subject.Trim());
        SettingsChanged?.Invoke(this, EventArgs.Empty);
    }
