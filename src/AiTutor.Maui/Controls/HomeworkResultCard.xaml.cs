...
public partial class HomeworkResultCard : ContentView
{
    ...
    public static readonly BindableProperty ExplainCommandParameterProperty = BindableProperty.Create(nameof(ExplainCommandParameter), typeof(object), typeof(HomeworkResultCard));
    ...
    public static readonly BindableProperty AddWrongCommandParameterProperty = BindableProperty.Create(nameof(AddWrongCommandParameter), typeof(object), typeof(HomeworkResultCard));
    ...
    public static readonly BindableProperty PracticeCommandParameterProperty = BindableProperty.Create(nameof(PracticeCommandParameter), typeof(object), typeof(HomeworkResultCard));
    ...
    public object? ExplainCommandParameter { get => GetValue(ExplainCommandParameterProperty); set => SetValue(ExplainCommandParameterProperty, value); }
    public ICommand? AddWrongCommand { get => (ICommand?)GetValue(AddWrongCommandProperty); set => SetValue(AddWrongCommandProperty, value); }
    public object? AddWrongCommandParameter { get => GetValue(AddWrongCommandParameterProperty); set => SetValue(AddWrongCommandParameterProperty, value); }
    public ICommand? PracticeCommand { get => (ICommand?)GetValue(PracticeCommandProperty); set => SetValue(PracticeCommandProperty, value); }
    public object? PracticeCommandParameter { get => GetValue(PracticeCommandParameterProperty); set => SetValue(PracticeCommandParameterProperty, value); }
}
